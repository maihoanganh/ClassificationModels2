module ClassificationModels2

using LinearAlgebra, SparseArrays, Arpack, Plots, SCS, Convex, COSMO, SpecialFunctions, Printf, DelimitedFiles, CSV, DataFrames, JuMP, MosekTools
